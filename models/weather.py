...
class Main:
    ...
    def __init__(self, temp: float, feels_like: float, temp_min: float, temp_max: float, pressure: int, humidity: int, sea_level: int, grnd_level: int) -> None:
        self.temp = temp
    ...
    def from_dict(obj: Any) -> 'Main':
        ...
        return Main(temp, feels_like, temp_min, temp_max, pressure, humidity, sea_level, grnd_level)
...
class Weather:
    ...
    def __init__(self, coord: Coord, weather: List[WeatherElement], base: str, main: Main, visibility: int, wind: Wind, clouds: Clouds, dt: int, sys: Sys, timezone: int, id: int, name: str, cod: int) -> None:
        self.coord = coord
